...
def outline_obstacles_demo_building_1(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(2, 6 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(6 * dynamic_size)
    for i in arange(2, 6 * dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(0, 22 * dynamic_size):
        obstacle_y.append(i)
...
def outline_obstacles_demo_building_2(obstacle_x, obstacle_y, dynamic_size):
    ...
    # outline exit/enter 1
    for i in arange(54 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
    ...
    for i in arange(0, 10 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(42 * dynamic_size)
    for i in arange(0, 10 * dynamic_size):
        obstacle_y.append(i)
...
def outline_obstacles_demo_building_3(obstacle_x, obstacle_y, dynamic_size):
    ...
    # outline exit/enter 1
    for i in arange(3, 7 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(8 * dynamic_size)
    for i in arange(3, 7 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(13 * dynamic_size)

    # outline exit/enter 2
    for i in arange(2, 5 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(48 * dynamic_size)
    for i in arange(2, 5 * dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(44 * dynamic_size, 60 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(53 * dynamic_size)
...
def outline_obstacles_demo_building_4(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(0, 9 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(11 * dynamic_size, 21 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    ...
    for i in arange(40 * dynamic_size, 49 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(20 * dynamic_size)
    for i in arange(51 * dynamic_size, 61 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(20 * dynamic_size)
    ...
    for i in arange(0, 7 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(10 * dynamic_size)
    for i in arange(10 * dynamic_size, 31 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(7 * dynamic_size)
...
def outline_obstacles_demo_building_5(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(45 * dynamic_size, 49 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(51 * dynamic_size, 56 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(30 * dynamic_size, 41 * dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(54 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(51 * dynamic_size)
    for i in arange(54 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(45 * dynamic_size)
...
def outline_obstacles_demo_building_6(obstacle_x, obstacle_y, dynamic_size):
    ...
    # outline exit/enter 2 top
    for i in arange(53 * dynamic_size, 57 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(21 * dynamic_size)
    for i in arange(53 * dynamic_size, 57 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(15 * dynamic_size)
    ...
    for i in arange(2, 6 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(27 * dynamic_size)
...
def outline_obstacles_demo_building_7(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(30 * dynamic_size, 34 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(22 * dynamic_size)
    for i in arange(37 * dynamic_size, 41 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(22 * dynamic_size)
    for i in arange(0, 22 * dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(30 * dynamic_size, 33 * dynamic_size):
        obstacle_x.append(10 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(36 * dynamic_size, 40 * dynamic_size):
        obstacle_x.append(10 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(0, 11 * dynamic_size):
        obstacle_x.append(i)
...
def outline_obstacles_demo_building_8(obstacle_x, obstacle_y, dynamic_size):
    #  outline of room
    for i in arange(20 * dynamic_size, 40 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(0.0)
    for i in arange(21 * dynamic_size,40 * dynamic_size):
        obstacle_x.append(60.0 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(21 * dynamic_size,40 * dynamic_size):
        obstacle_x.append(i)
    ...
    j = 61 * dynamic_size
    for i in arange(40 * dynamic_size, j):
        obstacle_x.append(i)
        obstacle_y.append(j-1)
        j -= 1
    ...
    for i in arange(11 * dynamic_size, 17 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(22 * dynamic_size)
    for i in arange(9 * dynamic_size, 22 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(11 * dynamic_size)
    for i in arange(3 * dynamic_size, 22 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(16 * dynamic_size)
    ...
    # outline obst rectangle in the middle
    for i in arange(25 * dynamic_size, 40 * dynamic_size):
        obstacle_x.append(20 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(25 * dynamic_size, 40 * dynamic_size):
        obstacle_x.append(25 * dynamic_size)
    ...
    for i in arange(40 * dynamic_size, 60 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(30 * dynamic_size)
    for i in arange(40 * dynamic_size, 55 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(45 * dynamic_size)
    ...
    # outline exit/enter 2
    for i in arange(55 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(55 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
...
def outline_obstacles_demo_building_9(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(30 * dynamic_size, 61 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(0.0)
    for i in arange(0, 61 * dynamic_size):
        obstacle_x.append(60.0 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(30 * dynamic_size, 61 * dynamic_size):
        obstacle_x.append(i)
    ...
    # outline exit/enter 1
    for i in arange(9 * dynamic_size, 13 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(22 * dynamic_size)
    for i in arange(8 * dynamic_size, 13 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(26 * dynamic_size)
    ...
    for i in arange(11 * dynamic_size, 17 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(22 * dynamic_size)
    for i in arange(18 * dynamic_size, 22 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(11 * dynamic_size)
    for i in arange(13 * dynamic_size, 22 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(16 * dynamic_size)
    ...
    for i in arange(40 * dynamic_size, 45 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(45 * dynamic_size)
    for i in arange(48 * dynamic_size, 60 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(45 * dynamic_size)
    ...
    for i in arange(55 * dynamic_size, 59 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(36 * dynamic_size)
...
def outline_obstacles_demo_building_10(obstacle_x, obstacle_y, dynamic_size):
    #  outline of room
    for i in arange(0, 40 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(0.0)
    for i in arange(21 * dynamic_size, 61 * dynamic_size):
        obstacle_x.append(60.0 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(21 * dynamic_size, 61 * dynamic_size):
        obstacle_x.append(i)
    ...
    # outline obst
    for i in arange(30 * dynamic_size, 36 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(39 * dynamic_size, 45 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(40 * dynamic_size, 60 * dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(55 * dynamic_size, 60 * dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(35 * dynamic_size)
    for i in arange(25 * dynamic_size, 29 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(55 * dynamic_size)
    for i in arange(32 * dynamic_size, 36 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(55 * dynamic_size)
    ...
    for i in arange(54 * dynamic_size, 59 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(52 * dynamic_size)
    for i in arange(64 * dynamic_size, 59 * dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(56 * dynamic_size)
