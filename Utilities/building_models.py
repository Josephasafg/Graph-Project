...
def outline_obstacles_demo_building_1(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(4 * dynamic_size, 8 * dynamic_size, dynamic_size):
    ...
    for i in arange(0 * dynamic_size, 22 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(30 * dynamic_size, 35 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(40 * dynamic_size)
    for i in arange(40 * dynamic_size, 43 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
...
def outline_obstacles_demo_building_2(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(40 * dynamic_size, 60 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(30 * dynamic_size)
    for i in arange(30 * dynamic_size, 60 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(40 * dynamic_size)
    ...
    for i in arange(0, 12 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(40 * dynamic_size, 51 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(13 * dynamic_size, 25 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(7 * dynamic_size)
    for i in arange(30 * dynamic_size, 41 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(7 * dynamic_size)
    ...
    for i in arange(0, 17 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(13 * dynamic_size)
    for i in arange(7 * dynamic_size, 14 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(25 * dynamic_size, 28 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(30 * dynamic_size)
    for i in arange(25 * dynamic_size, 28 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
    ...
    j = 5
    for i in arange((30 - j) * dynamic_size, (34 - j) * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append((25 - j) * dynamic_size)
    for i in arange((30 - j) * dynamic_size, (35 - j) * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append((28 - j) * dynamic_size)
    for i in arange((25 - j) * dynamic_size, (28 - j) * dynamic_size, dynamic_size):
        obstacle_x.append(i)
    ...
    for i in arange(54 * dynamic_size, 58 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(13 * dynamic_size)
    for i in arange(13 * dynamic_size, 17 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(42 * dynamic_size, 56 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(22 * dynamic_size)
    for i in arange(22 * dynamic_size, 30 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(52 * dynamic_size, 56 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
...
def outline_obstacles_demo_building_3(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(40 * dynamic_size, 60 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(0.0)
    for i in arange(0.0, 60 * dynamic_size, dynamic_size):
        obstacle_x.append(60.0 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(0.0, 61 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(60.0 * dynamic_size)
    for i in arange(0, 61 * dynamic_size, dynamic_size):
        obstacle_x.append(0.0)
        obstacle_y.append(i)
    for i in arange(0, 30 * dynamic_size, dynamic_size):
        obstacle_x.append(20 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(0, 30 * dynamic_size, dynamic_size):
        obstacle_x.append(40 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(20 * dynamic_size, 41 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(30 * dynamic_size)
    ...
    for i in arange(49 * dynamic_size, 54 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(6 * dynamic_size)
    ...
    for i in arange(10 * dynamic_size, 22 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(7 * dynamic_size)
    for i in arange(26 * dynamic_size, 31 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(7 * dynamic_size)

    # outline obst top right
    for i in arange(53 * dynamic_size, 60 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(30 * dynamic_size)
    for i in arange(30 * dynamic_size, 41 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(53 * dynamic_size)
    for i in arange(46 * dynamic_size, 60 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(53 * dynamic_size)
    ...
    for i in arange(40 * dynamic_size, 45 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(30 * dynamic_size)
    for i in arange(40 * dynamic_size, 44 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(10 * dynamic_size)
    for i in arange(10 * dynamic_size, 30 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
...
def outline_obstacles_demo_building_4(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(0, 61 * dynamic_size, dynamic_size):
        obstacle_x.append(0.0)
        obstacle_y.append(i)
    for i in arange(0 * dynamic_size, 20 * dynamic_size, dynamic_size):
        obstacle_x.append(20 * dynamic_size)
        obstacle_y.append(i)
    for i in arange(0, 20 * dynamic_size, dynamic_size):
        obstacle_x.append(40 * dynamic_size)
    ...
    for i in arange(28 * dynamic_size, 33 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(34 * dynamic_size)
    ...
    for i in arange(20 * dynamic_size, 29 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(28 * dynamic_size)
    for i in arange(20 * dynamic_size, 29 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(0, 9 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(14 * dynamic_size, 21 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)

    # outline obstacle bottom right
    for i in arange(40 * dynamic_size, 49 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(20 * dynamic_size)
    for i in arange(53 * dynamic_size, 61 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(20 * dynamic_size)

    # outline exit/enter 1
    for i in arange(5 * dynamic_size, 9 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(11 * dynamic_size)
    for i in arange(5 * dynamic_size, 9 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(0, 7 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(10 * dynamic_size)
    for i in arange(47 * dynamic_size, 52 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
    ...
    for i in arange(42 * dynamic_size, 58 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(44 * dynamic_size)
...
def outline_obstacles_demo_building_5(obstacle_x, obstacle_y, dynamic_size):
    ...
    for i in arange(45 * dynamic_size, 49 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(53 * dynamic_size, 56 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(40 * dynamic_size)
    for i in arange(30 * dynamic_size, 41 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
    ...
    for i in arange(3 * dynamic_size, 6 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(27 * dynamic_size)
    for i in arange(23 * dynamic_size, 28 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
    ...
    for i in arange(55 * dynamic_size, 58 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(58 * dynamic_size)
    for i in arange(53 * dynamic_size, 59 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
        obstacle_x.append(58 * dynamic_size)

    # outline exit/enter 3 top left
    for i in arange(2 * dynamic_size, 5 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(53 * dynamic_size)
    for i in arange(2 * dynamic_size, 5 * dynamic_size, dynamic_size):
        obstacle_x.append(i)
        obstacle_y.append(57 * dynamic_size)
    for i in arange(53 * dynamic_size, 58 * dynamic_size, dynamic_size):
        obstacle_y.append(i)
